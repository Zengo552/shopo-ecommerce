...
export default function Login() {
  ...
  const handleLogin = async () => {
    ...
    // Placeholder endpoint. Update this to your actual backend URL.
    ...
    try {
      ...
      // Improved error handling to provide a more specific message for network-related errors.
                  ...
                  <div className="signin-area mb-3.5">
                    <div className="flex justify-center">
                      <button
                        ...
                        onClick={handleLogin}
                        disabled={loading}
                        className="black-btn mb-6 text-sm text-white w-full h-[50px] font-semibold flex justify-center bg-purple items-center rounded-md disabled:bg-gray-400"
                      >
                        <span>Log In</span>
                      </button>
                    </div>
