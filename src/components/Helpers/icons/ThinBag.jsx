export default function ThinBag({ 
  className = "", 
  size = 18,
  color = "currentColor",
  strokeWidth = 1.5,
  ...
  return (
    <div className="relative inline-block">
      <svg
        width={size}
        height={size + 2} // Adjust height to maintain aspect ratio
        viewBox="0 0 18 20"
      ...
      >
        <path
          ...
          className={filled ? "" : "transition-colors duration-200 hover:stroke-gray-700"}
        />
      </svg>

      {/* Notification badge */}
      {withNotification && itemCount > 0 && (
